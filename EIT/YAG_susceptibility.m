function result = YAG_susceptibility( omega_p )
%Constants
...
VAR.tau_2=2.0e-6;
VAR.tau_3=0.5e-6;
VAR.omega_31=0; %this is not used: assume resonant frequency
VAR.omega_21=0; %this is not used: we moved the resonant out of function
VAR.omega_p=NaN; %this is not used: probe frequency = Casimir Frequencies; not used
VAR.omega_c=VAR.omega_31; %Assuming resonant point

%computing Gamma
VAR.Gamma_21=200; %THIS IS REQUIRED!!!! WHERE TO FIND!!!!
VAR.Gamma_31=0; %Assumed in paper
VAR.Gamma_32=NaN; %this is not needed
...
VAR.delta_c= -1e7;%VAR.omega_31 - VAR.omega_c;
