...
function result = CasimirForcePerfectSI(PositionX)
t=0;
omegat=0;
IT=0;
...
result = CONST.h_bar./2./pi^2 .* k .* temp_sqrt .* ( (temp1./(1-temp1)) + (temp2./(1-temp2)));
...
eta_B_2 = As2S3(1i.*xi,2*pi*CONST.c/CONST.lambda0,3);
end
...
epsilon_B = As2S3(1i.*xi,2*pi*CONST.c/CONST.lambda0,1);
end
...
mu_B = As2S3(1i.*xi,2*pi*CONST.c/CONST.lambda0,2);
end
