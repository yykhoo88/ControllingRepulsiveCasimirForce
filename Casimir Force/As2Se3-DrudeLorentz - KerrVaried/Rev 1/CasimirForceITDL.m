...
function result = CasimirForceITDL(t,omegat,PositionX,IT)
...
eta_B_2 = As2S3(1i.*xi,2*pi*CONST.c/CONST.lambda0,3,CONST);
end

%Dielectric constant for plate B
function epsilon_B = epsilon_B_calc(xi,k,CONST)
epsilon_B = As2S3(1i.*xi,2*pi*CONST.c/CONST.lambda0,1,CONST);
end

%Permeability for plate B
function mu_B = mu_B_calc(xi,k,CONST)
mu_B = As2S3(1i.*xi,2*pi*CONST.c/CONST.lambda0,2,CONST);
end
