...
test1 = (xi < (CONST.omegat*2*pi*CONST.c/CONST.lambda0)).*10;
test2 = (xi >= (CONST.omegat*2*pi*CONST.c/CONST.lambda0)).*1;
...
test1 = (xi < (CONST.omegat*2*pi*CONST.c/CONST.lambda0)).*0.5;
test2 = (xi >= (CONST.omegat*2*pi*CONST.c/CONST.lambda0)).*100;
mu_A = test1 + test2;
end
