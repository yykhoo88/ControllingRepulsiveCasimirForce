...
function result = CasimirForceITDL(PositionX,omega_p,omega_t)
t=0;
...
CONST.omega_p=omega_p;
CONST.omega_t=omega_t;
...
mu_B = 1;%DrudeLorentz(1i.*xi,2*pi*CONST.c/CONST.lambda0,2);
end
